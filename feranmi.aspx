<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="feranmi.aspx.vb" Inherits="Idowu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Image ID="Image12" runat="server" Height="68px" 
                ...
                <asp:Label ID="Label1" runat="server" Text="FERANMI'S BIRTHDAY" 
    ...
    <br />
    <div>
		   <center><obshow:Show ID="Show1" runat="server" Height="450" ScrollDirection="Left" 
		    ...
		    <Panels>
			    <obshow:Panel>
				    <table class="panelTable">
					    <tr>
						    <td >
							    <a href="http://www.obout.com/em/">
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/AWARD CEREMONIES/Feranmi's Bday/IMG_4783.JPG" Width="920px"  Height="320" />
							    </a>
						    </td>
                        ...
                        <tr>
                        <td bgcolor="#000066">
                                <center> <asp:Label ID="Label2" runat="server" Text="FERANMI AND FRIENDS" ForeColor="White"></asp:Label></center>
						    </td>
                        </tr>
			    ...
			    <obshow:Panel>
				    <table class="panelTable">
					    <tr>
						    <td width="100%">
							    <a href="http://www.obout.com/em/">
                                    <asp:Image ID="Image2" runat="server" ImageUrl="~/AWARD CEREMONIES/Feranmi's Bday/IMG_4798.JPG"  Width="920px"  Height="320" />
							    </a>
						    </td>
                        ...
                        <tr>
                        <td  bgcolor="#000066">
                                 <asp:Label ID="Label7" runat="server" Text=" FERANMI AND FRIENDS" ForeColor="White" ></asp:Label>
						    </td>
                        </tr>
				    </table>
			    </obshow:Panel>
			    <obshow:Panel>
				    <table class="panelTable">
					    <tr>
						    <td width="100%">
							    <a href="http://www.obout.com/em/">
                                    <asp:Image ID="Image3" runat="server" ImageUrl="~/AWARD CEREMONIES/Feranmi's Bday/IMG_4807.JPG"  Width="920px"  Height="320" />
							    </a>
						    </td>
                        ...
                        <tr>
                        <td bgcolor="#000066" >
                                 <asp:Label ID="Label3" runat="server" Text=" FERANMI ALONE " ForeColor="White"></asp:Label>
						    </td>
                        </tr>
				    </table>
			    </obshow:Panel>
			    <obshow:Panel>
				    <table class="panelTable">
					    <tr>
						    <td width="100%">
							    <a href="http://www.obout.com/em/">
                                    <asp:Image ID="Image4" runat="server" ImageUrl="~/AWARD CEREMONIES/Feranmi's Bday/IMG_4809.JPG"  Width="920px"  Height="320" />
							    </a>
						    </td>
                        ...
                        <tr>
                        <td  bgcolor="#000066" >
                                 <asp:Label ID="Label4" runat="server" Text="FERANMI AND FRIENDS" ForeColor="White"></asp:Label>
						    </td>
                        </tr>
				    </table>
			    </obshow:Panel>
