<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Idowu.aspx.vb" Inherits="Idowu" %>
...
<style type="text/css">
    ...
    <asp:Image ID="Image12" runat="server" Height="68px" 
                ...
                <asp:Label ID="Label1" runat="server" Text="IDOWU AND TOYIN" 
