<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Fadira.aspx.vb" Inherits="Idowu" %>
...
<style type="text/css">
    ...
    <asp:Image ID="Image12" runat="server" Height="68px" 
                ...
                <asp:Label ID="Label1" runat="server" Text="FARIDA'S BIRTHDAY" 
